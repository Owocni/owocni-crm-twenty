...
in JSON format. Supports both BIR 1.1 and BIR 1.2 API versions, including PKD
2025 classification. Data returned from original SOAP messages are parsed to
