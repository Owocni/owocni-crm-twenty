...
**Entry point repo:** [`../README.md`](../README.md). **Agent LLM (obowiązkowo):** [`../AGENTS.md`](../AGENTS.md). **Review dokumentacji:** [`../REVIEW_PACKAGE.md`](../REVIEW_PACKAGE.md). **NIE czytać:** [`../_DO_USUNIECIA/`](../_DO_USUNIECIA/README.md) (stara dokumentacja i proces refaktoryzacji — docelowo usunąć).
